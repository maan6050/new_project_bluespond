...
namespace App\Filament\Dashboard\Resources\Services\RelationManagers;
...
/**
 * Manages which staff members can perform a given service.
 *
 * Shown on the Service edit page. The pivot stores optional per-staff price
 * and duration overrides; a null override means "use the service's own value".
 */
        ...
        return $table
            ...
            ->headerActions([
                AttachAction::make()
                    ...
                    ->modalHeading(__('Assign a staff member'))
                    ->preloadRecordSelect()
